...
void Game::Initialize(){
	...
	engine->Get<nc::AudioSystem>()->AddAudio("explosion", "die.wav");
	engine->Get<nc::AudioSystem>()->AddAudio("enemyfire", "enemyfire.wav");
	engine->Get<nc::AudioSystem>()->AddAudio("playerfire", "playerfire.wav");
...
void Game::Draw(Core::Graphics& graphics){
	...
	case Game::eState::Title:
	{
		...
		graphics.DrawString(360, 300 + static_cast<int>(std::sin(stateTimer * 6.0f) * 10.0f), "Shooter");
